...
/**
 * 生成指定数量的男生和女生姓名信息，并添加年龄和性别标识
 * @param familyList 姓氏列表
 * @param boyList 男生名字列表
 * @param girlList 女生名字列表
 * @param boyCount 需要生成的男生数量
 * @param girlCount 需要生成的女生数量
 * @return 返回包含姓名、性别和年龄信息的ArrayList
 */
